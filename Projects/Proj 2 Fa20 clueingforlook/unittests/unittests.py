...
class TestArgmax(TestCase):
    ...
    def test_6(self):
        ...
        # create an array in the data section
        # TODO
        array = t.array([0x8000000,0x8000000])
        # load address of the array into register a0
        # TODO
        t.input_array("a0",array)
        # set a1 to the length of the array
    ...
    def test_7(self):
        ...
        # create an array in the data section
        # TODO
        array = t.array([0x8000000,0x7fffffff])
        # load address of the array into register a0
        # TODO
        t.input_array("a0",array)
        # set a1 to the length of the array
...
class TestDot(TestCase):
    ...
    def test_error_a2(self):
        ...
        t.input_scalar("a4", 1)
        t.call("dot")
        t.execute(code=75)  # Expect error code 75

    def test_error_a4(self):
        t = AssemblyTest(self, "dot.s")
        array1 = t.array([1, 2, 3])
        array2 = t.array([4, 5, 6])
        t.input_array("a0", array1)
        ...
        t.call("dot")
        t.execute(code=76)  # Expect error code 76
